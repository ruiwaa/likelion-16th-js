...
// 1. 당황하여 코드를 모두 지운다.
// 2. "어디서 잘못됐을까?" 스스로 질문하며 메시지를 읽는다.(정답)
...
alarmButton.addEventListener('click', handleRing) // 핸들러 함수를 불러와야함, 실행이 아님
...
calcButton.addEventListener('click', () => {
  ...
  resultDisplay.textContent = total.toLocaleString() //반환값에 꼼마를 넣어줄 수 있는 메서드
})
