...
console.log(Number(INVALID_PRICE))
// 출력 결과: NaN (number)
let invalid_calculation
invalid_calculation = Number(INVALID_PRICE) * 10
...
// 나이를 숫자로 변환하세요.
// 출력 결과: 28 (number)
let age_number = parseInt(USER_AGE)
console.log(age_number, typeof(age_number))
...
console.log(Math.floor(bmi), typeof(bmi))
...
// 로그인 횟수를 숫자로 변환하세요.
// 출력 결과: 0 (number)
let login_count_number = parseInt(LOGIN_COUNT)
console.log(login_count_number, typeof(login_count_number))
...
let is_coupon_valid = !!(coupon_number)
...
let test_1_boolean =!!TEST_VALUE_1
// 출력 결과: true (빈 문자열이 아니기 때문)
